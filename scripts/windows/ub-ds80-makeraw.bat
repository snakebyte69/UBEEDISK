::==============================================================================
:: ub-ds80-makeraw - Creates a formatted Microbee DS80 raw file.
:: SJK 2010/07/17.
::
:: Usage: ub-ds80-makeraw filename
::
...
ubeedisk --disk=format --force --verbose=0 --format=ds80 --otype=raw --of=%1
goto done

:usage
echo %0 - Creates a formatted Microbee DS80 raw file.
