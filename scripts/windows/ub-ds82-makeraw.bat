::==============================================================================
:: ub-ds82-makeraw - Creates a formatted Microbee DS82 raw file.
:: SJK 2010/07/17.
::
:: Usage: ub-ds82-makeraw filename
::
...
ubeedisk --disk=format --force --verbose=0 --format=ds82 --otype=raw --of=%1
goto done

:usage
echo %0 - Creates a formatted Microbee DS82 raw file.
