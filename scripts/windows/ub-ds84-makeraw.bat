::==============================================================================
:: ub-ds84-makeraw - Creates a formatted Microbee DS84 raw file.
:: SJK 2010/07/17.
::
:: Usage: ub-ds84-makeraw filename
::
...
ubeedisk --disk=format --force --verbose=0 --format=ds84 --otype=raw --of=%1
goto done

:usage
echo %0 - Creates a formatted Microbee DS84 raw file.
